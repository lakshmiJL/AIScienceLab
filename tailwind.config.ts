  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-volcano': 'var(--gradient-volcano)',
        'gradient-electric': 'var(--gradient-electric)',
        'gradient-gravity': 'var(--gradient-gravity)',
        'gradient-rocket': 'var(--gradient-rocket)',
      ...
      keyframes: {
        ...
        "shake": { "0%,100%": { transform: "translate(0,0)" }, "25%": { transform: "translate(-2px,2px)" }, "50%": { transform: "translate(2px,-1px)" }, "75%": { transform: "translate(-1px,-2px)" } },
      },
      animation: {
